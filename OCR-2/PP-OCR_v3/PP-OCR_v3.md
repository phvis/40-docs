...
​        PaddleOCR旨在打造一套丰富、领先、且实用的OCR工具库，助力开发者训练出更好的模型，并应用落地。[PP-OCRv3](./doc/doc_ch/ppocr_introduction.md#pp-ocrv3)，速度可比情况下，中文场景效果相比于PP-OCRv2再提升5%，英文场景提升11%，80语种多语言模型平均识别准确率提升5%以上。

![](docs.assets/00006737.jpg)

![](docs.assets/test_add_91.jpg)
...
* 方式二：
  下载`PaddleOCR`代码后，进入`PaddleOCR`代码文件夹目录下面
...
![](docs.assets/20221210220240338.jpg)
...
- 使用```PaddleOCR/configs/mot/fairmot/fairmot_dla34_30e_1088x608.yml ```配置文件 ；
...
![](docs.assets/456ae2acb27d4a94896c478812aee0bc3551c703d7bd40c9be4dc983c7b3fc8a.png)
...
![](docs.assets/20221210221216635.jpg)
...
![image-20221127182523424](docs.assets/d686a48d465a43d09fbee51924fdca42ee21c50e676646da8559fb9967b94185.png)
...
![20221210221358983](docs.assets/20221210221358983.jpg)
...
!python -m paddle.distributed.launch  --gpus 0 \
					tools/train.py -c configs/rec/PP-OCRv3/ch_PP-OCRv3_rec_distillation.yml \
                       -r  output/ch_PP-OCRv3_rec_train/10
                       Global.epoch_num=20 \
                       Global.eval_batch_step='[0, 20]' \
                       Train.dataset.data_dir=./data \
                       Train.dataset.label_file_list=['./data/render_train.list'] \
